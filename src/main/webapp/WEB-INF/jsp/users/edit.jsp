...
<body>
    <div class="bg-page py-5">
        <div class="container">
            <!-- main-heading -->
            <p>${messages}</p>
            <h2 class="main-title-w3layouts mb-2 text-center text-white"> Cập Nhật Thông tin</h2>
            <!--// main-heading -->
            <div class="form-body-w3-agile text-center w-lg-50 w-sm-75 w-100 mx-auto mt-5">
                <form:form action="/editUser" modelAttribute="user" enctype="multipart/form-data" method="post">
            	<form:hidden path="id"/>
